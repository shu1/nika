...
function setupTutorialPart(part) {
	gameMan.tutorialPart = part;
	generateGrid(tutorialBoards[gameMan.tutorialPart]);
	resetActions(0);
}
...
function setupTutorial() {
	...
	if (board) {
		console.log('New tutorial', gameMan.tutorialStep);
		loadGameState(board);
	} else {
		console.log('Old tutorial', gameMan.tutorialStep);
