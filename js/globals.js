...
var tutorialTexts = [[
	...
	"Fortunately, we can split pieces off from a phalanx. Double tap the indicated piece to enter phalanx sub-selection mode."
],[
	"Now, to the attack! Select only the forward piece by double-tapping it, then rout the exposed Theban. Remember - unlike a phalanx, a single piece can move in any direction!"
],[
