...
var tutorialTexts = [[
	...
	"We can take two actions on our turn." // 10
],[
	...
	"Pieces can rotate to face any direction","in one action. Well done - the men are","safe, for now." // 18
],[
	...
	"We move through these spaces","normally, but our enemies are not","allowed to enter them." // 22
],[
	...
	"Deftly done! You can now move","the smaller phalanx you created by","dragging it forward as normal." // 33
],[
	...
	"We have struck first without leaving","our men vulnerable. Masterful!"	// 35
],[
	...
	"We cannot push in this line, as there is","only one Athenian facing one Theban.","Our soldier here is stuck." // 40
],[
	...
	"If we push an enemy piece off the","battlefield, that enemy is routed.","Push that Spartan to take him out!" // 45
],[
	...
	"Congratulations! You now know","everything you need to play Nika." // 51
],[
